...
input_index_variant_file = 'variant_include_index_1.rds'
input_other_variant_file = 'variant_include_index_2.rds'
...
class Platform(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.inputs['variant_include_file_1'] = cls.session.files.query(
            names=[input_index_variant_file],
            parent=testdir
        )[0]
        cls.inputs['variant_include_file_2'] = cls.session.files.query(
            names=[input_other_variant_file],
            parent=testdir
        )[0]
